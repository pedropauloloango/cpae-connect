-- Configuração de abertura/fechamento das inscrições públicas do curso
...
COMMENT ON TABLE public.saude_mental_inscricao_config IS
  'Configuração singleton para habilitar/desabilitar inscrições públicas no curso de Saúde Mental.';
COMMENT ON COLUMN public.saude_mental_inscricao_config.encerramento_em IS
  'Data/hora limite para novas inscrições. Após este instante, o formulário público fica fechado.';
